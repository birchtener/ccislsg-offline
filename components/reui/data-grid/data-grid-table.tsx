...
function DataGridTableHeadRowCell<TData>({
  ...
  return (
    <th
      ...
      className={cn(
        "text-foreground relative min-h-10 h-auto py-2 text-left align-middle font-medium rtl:text-right [&:has([role=checkbox])]:pe-0",
        headerCellSpacing,
  ...
  return (
    <td
      ...
      className={cn(
        ...
        props.tableLayout?.columnsPinnable &&
          column.getCanPin() &&
          "data-pinned:bg-data-grid-bg data-pinned:isolate [&[data-pinned=left][data-last-col=left]]:shadow-[inset_-1px_0_0_0_var(--border)] [&[data-pinned=right][data-last-col=right]]:shadow-[inset_1px_0_0_0_var(--border)]",
        column.getIndex() === 0 ||
    ...
    <td
      ...
      className={cn(
        ...
        props.tableLayout?.columnsPinnable &&
          column.getCanPin() &&
          cn(
            "data-pinned:bg-data-grid-bg data-pinned:isolate",
